...
public class GlobalExceptionHandler {
        ...
        @ExceptionHandler(value = {InvalidPwdException.class})
        ...
        @ResponseStatus(HttpStatus.BAD_REQUEST)
        @ExceptionHandler({AgentIsPresentException.class, AgentNotFoundException.class,PasswordIncorectException.class,InvalidDateException.class})
